    ...
    public class MockFile : FileBase
    {
        ...
        public override void AppendAllText(string path, string contents, Encoding encoding)
        {
            ...
            if (!mockFileDataAccessor.FileExists(path))
            {
                ...
                {
                    throw new DirectoryNotFoundException(string.Format(CultureInfo.InvariantCulture, "COULD_NOT_FIND_PART_OF_PATH_EXCEPTION", path));
                }
        ...
        public override void Copy(string sourceFileName, string destFileName, bool overwrite)
        {
            ...
            {
                throw new ArgumentNullException("sourceFileName", "FILENAME_CANNOT_BE_NULL");
            }

            if (destFileName == null)
            {
                throw new ArgumentNullException("destFileName", "FILENAME_CANNOT_BE_NULL");
            }
            ...
            {
                throw new DirectoryNotFoundException(string.Format(CultureInfo.InvariantCulture, "COULD_NOT_FIND_PART_OF_PATH_EXCEPTION", destFileName));
            }
        ...
        public override FileAttributes GetAttributes(string path)
        {
            if (path != null)
            {
                if (path.Length == 0)
                {
                    throw new ArgumentException("THE_PATH_IS_NOT_OF_A_LEGAL_FORM", "path");
                }
            }
       ...
       /// <summary>
        ...
        public override void WriteAllText(string path, string contents, Encoding encoding)
        {
            ...
            {
                throw new UnauthorizedAccessException(string.Format(CultureInfo.InvariantCulture, "ACCESS_TO_THE_PATH_IS_DENIED", path));
            }
        ...
        private void VerifyValueIsNotNull(object value, string parameterName)
        {
            if (value == null)
            {
                throw new ArgumentNullException(parameterName, "VALUE_CANNOT_BE_NULL");
            }
        }
        ...
        private void VerifyDirectoryExists(string path)
        {
            ...
            if (!dir.Exists)
            {
                throw new DirectoryNotFoundException(string.Format(CultureInfo.InvariantCulture, "COULD_NOT_FIND_PART_OF_PATH_EXCEPTION", dir));
            }
        }
    }
}